...
CATEGORY_KEYWORDS: dict[str, list[str]] = {
    "Vegetables": [
        ...
        "פלפל", "פלפל אדום", "פלפל צהוב", "פלפל ירוק", "גמבה", "גמבות", "ברוקולי", "כרובית", "כרוב",
    ...
    "Dairy & Eggs": [
        ...
        "לורפק", "ממרח לורפק", "דניאלה", "סקוויזי גמדים", "לבאנה",
    ],
    "Meat & Fish": [
        ...
        "קורנדביף", "פסטרמה", "בייקון", "סלמון", "דג דניס", "דניס", "פילה בקלה", "בקלה", "טונה",
    ...
    "Pantry": [
        ...
        "שמן קנולה", "רסק עגבניות", "עגבניות מרוסקות", "שעועית", "שעועית משומרת",
    ...
    "Frozen": [
        ...
        "וופל קפוא", "צ'יפס קפוא", "בוריטו קפוא", "טבעות בצל",
        "מלוואח", "מלאווח", "ג'חנון", "גחנון",
        "שניצל ברוקולי", "שניצלי ברוקולי",
    ],
    "Chilled": [
        "hummus salad", "tahini salad", "hummus",
        # Hebrew — refrigerated deli salads and dips
        "סלט חומוס", "סלט טחינה", "סלט כרוב אדום", "סלטי כרוב אדום", "חומוס",
    ],
    "Beverages": [
    ...
    "Snacks": [
        ...
        "ביסלי", "פריכיות", "פריכית", "קליק", "תפוצ'יפס", "דוריטוס",
        "גרעינים", "חטיף אורז", "ערגליות תות",
    ],
    "Sweets": [
        "wafer", "wafers", "kinder",
