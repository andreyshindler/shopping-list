...
BOT_TEXT: dict[str, dict[str, str]] = {
    "he": {
        ...
        "btn_help": "❓ עזרה",
        "btn_scan": "📷 סריקת קבלה",
        "scan_prompt": "📷 שלחו לי תמונה של הקבלה ואעדכן את הרשימה הפעילה עם המוצרים והמחירים.",
        "scan_reading": "⏳ קורא את הקבלה…",
        "scan_not_configured": "סריקת קבלות אינה מוגדרת בבוט הזה.",
        "scan_failed": "לא הצלחתי לקרוא את הקבלה. נסו תמונה ברורה יותר.",
        "scan_no_items": "לא נמצאו מוצרים בקבלה.",
        "scan_no_active_note": "אין רשימה פעילה — אצור רשימה חדשה מהקבלה.",
        "scan_preview_title": "🧾 נמצאו {count} מוצרים בקבלה:",
        "scan_preview_matched": "✅ עדכון מוצרים קיימים:",
        "scan_preview_new": "➕ מוצרים חדשים:",
        "scan_preview_line": "• {name} — {price}",
        "scan_preview_total": "💰 סה\"כ: {amount}",
        "scan_preview_date": "📅 תאריך: {date}",
        "scan_confirm_hint": "לאשר ולעדכן את הרשימה?",
        "btn_scan_confirm": "✅ אישור ועדכון",
        "btn_scan_cancel": "❌ ביטול",
        "scan_applied": "✅ הרשימה עודכנה מהקבלה. {count} מוצרים, סה\"כ {amount}.",
        "scan_cancelled": "בוטל. הרשימה לא שונתה.",
        "scan_expired": "הסריקה פגה. שלחו את תמונת הקבלה שוב.",
        "users_header": "👥 משתמשים רשומים:",
        "users_none": "אין משתמשים רשומים.",
        "btn_back_users": "⬅️ משתמשים",
        "admin_user_lists_title": "📋 הרשימות של {name}:",
        "admin_no_lists": "אין רשימות למשתמש {name}.",
        "list_exported": "📄 הקובץ נשלח",
        "list_not_found": "הרשימה לא נמצאה.",
        ...
        "report_btn_export": "📄 ייצוא רשימה",
        "report_btn_open": "🛒 פתח רשימה",
        ...
        "confirm_delete_list": "למחוק את הרשימה הזו?",
        "list_deleted": "הרשימה נמחקה.",
        "btn_delete_year": "🗑 מחיקת שנה",
        "btn_delete_month": "🗑 מחיקת חודש",
        "btn_delete_list": "🗑 מחיקת רשימה",
        "btn_done": "✓ סיום",
        "confirm_delete_year": "למחוק את כל הרשימות משנת {year}?",
        "confirm_delete_month": "למחוק את כל הרשימות מ-{period}?",
        "lists_deleted": "{n} רשימות נמחקו.",
        ...
        "open_your_list": "🛒 רשימה",
        "draft_added": "✅ עוד {count} פריטים נוספו — סה״כ {total}\n",
        "btn_confirm_list": "✓ סיום",
        "draft_exists": "יש לך רשימה פתוחה. להוסיף אליה או לפתוח רשימה חדשה?",
        "btn_use_existing": "➕ להוסיף לרשימה הקיימת",
        "btn_create_new": "🆕 רשימה חדשה",
        "draft_choice_expired": "לא מצאתי את ההודעה המקורית. שלחו את המוצרים שוב.",
        "draft_confirmed": "✅ הרשימה מוכנה!",
    ...
    "en": {
        ...
        "btn_users": "👥 Users",
        "btn_help": "❓ Help",
        "btn_scan": "📷 Scan receipt",
        "scan_prompt": "📷 Send me a photo of your receipt and I'll update your active list with the products and prices.",
        "scan_reading": "⏳ Reading the receipt…",
        "scan_not_configured": "Receipt scanning is not configured for this bot.",
        "scan_failed": "I couldn't read that receipt. Try a clearer photo.",
        "scan_no_items": "No products found on the receipt.",
        "scan_no_active_note": "No active list — I'll create a new one from the receipt.",
        "scan_preview_title": "🧾 Found {count} products on the receipt:",
        "scan_preview_matched": "✅ Updating existing items:",
        "scan_preview_new": "➕ New items:",
        "scan_preview_line": "• {name} — {price}",
        "scan_preview_total": "💰 Total: {amount}",
        "scan_preview_date": "📅 Date: {date}",
        "scan_confirm_hint": "Apply this to your list?",
        "btn_scan_confirm": "✅ Confirm & update",
        "btn_scan_cancel": "❌ Cancel",
        "scan_applied": "✅ List updated from the receipt. {count} items, total {amount}.",
        "scan_cancelled": "Cancelled. Your list is unchanged.",
        "scan_expired": "That scan expired. Please send the receipt photo again.",
        "users_header": "👥 Registered users:",
        "users_none": "No registered users.",
        "btn_back_users": "⬅️ Users",
        "admin_user_lists_title": "📋 Lists of {name}:",
        "admin_no_lists": "No lists for {name}.",
        "list_exported": "📄 File sent",
        ...
        "report_list_line": "\n\n📋 List: {date} · {status} · #{id}",
        "report_btn_export": "📄 Export list",
        "report_btn_open": "🛒 Open list",
        ...
        "confirm_delete_list": "Delete this list?",
        "list_deleted": "List deleted.",
        "btn_delete_year": "🗑 Delete year",
        "btn_delete_month": "🗑 Delete month",
        "btn_delete_list": "🗑 Delete list",
        "btn_done": "✓ Done",
        "confirm_delete_year": "Delete all lists from {year}?",
        "confirm_delete_month": "Delete all lists from {period}?",
        "lists_deleted": "{n} lists deleted.",
        ...
        "open_your_list": "🛒 List",
        "draft_added": "✅ Added {count} more item(s) — {total} total\n",
        "btn_confirm_list": "✓ Done",
        "draft_exists": "You have an open list. Add to it, or start a new one?",
        "btn_use_existing": "➕ Add to existing list",
        "btn_create_new": "🆕 New list",
        "draft_choice_expired": "Couldn't find the original message. Please send the items again.",
        "draft_confirmed": "✅ List ready!",
...
def main_keyboard(lang: str, is_admin: bool = False) -> ReplyKeyboardMarkup:
    ...
    rows = [
        ...
        [KeyboardButton(text=tr["btn_scan"])],
